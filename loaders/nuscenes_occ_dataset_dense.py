...
class NuScenesOccDataset_dense(NuScenesDataset):    
    '''
        specifically for the lidar branch
        mainly modification: delete the sparse2dense fucntion
    '''
    ...
    def eval_riou(self, occ_results, runner=None, show_dir=None, **eval_kwargs):
        ...
        for i, batch in enumerate(data_loader):
            ...
            dense_sem_pred = occ_results[data_id]
