'''
    navie version:
        lidar branch: BEV through LiDAR backbone
...
pts_voxel_layer=dict(max_num_points=10, voxel_size=pc_voxel_size,
                        point_cloud_range=point_cloud_range,max_voxels=(120000, 160000))
...
load_from = 'ckpts/dal-large.pth'
prefix_keys_list = ['img_backbone','pts_backbone','pts_neck','pts_middle_encoder']
