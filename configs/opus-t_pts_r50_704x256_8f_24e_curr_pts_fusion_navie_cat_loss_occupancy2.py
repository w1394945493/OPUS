'''
    ...
    Adding occupancy loss, supervised by CrossEntropy Loss
    The weight for background is 0.2, the weight for foreground is 0.8 
'''
...
model = dict(
    ...
    pts_neck=pts_neck,
    pts_bbox_head=dict(
        type='OPUS_PT_Head_loss_occupancy',
        ...
        loss_lidar_occ=dict(type='CrossEntropyLoss', use_sigmoid=False,
                             loss_weight=1.0,class_weight=[0.2,0.8])
        ),
    train_cfg=dict(
        pts=dict(
            cls_weights=[
