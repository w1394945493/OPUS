...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Collect3D', 
                # keys=['img'],
                keys=['img', 'voxel_semantics', 'mask_camera'], 
                meta_keys=(
...
load_from = '/c20250502/wangyushen/Weights/pretrained/cascade_mask_rcnn_r50_fpn_coco-20e_20e_nuim_20201009_124951-40963960.pth'
